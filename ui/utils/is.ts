...
// 判断值是否已定义
export function isDefined<T>(val: T | null | undefined): val is Exclude<T, null | undefined> {
  return val !== undefined && val !== null
}

// 判断值是否未定义
export function isUndefined<T>(val: T | null | undefined): val is null | undefined {
